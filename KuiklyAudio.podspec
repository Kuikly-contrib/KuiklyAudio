Pod::Spec.new do |s|
  ...
  s.homepage         = 'https://github.com/Kuikly-contrib/KuiklyAudio'
  s.license          = { :type => 'MIT' }
  s.author           = { 'Kuikly' => '' }
  s.source           = { :git => 'https://github.com/Kuikly-contrib/KuiklyAudio.git', :tag => s.version.to_s }

  s.ios.deployment_target = '13.0'
  s.source_files = 'KuiklyAudioIOS/Classes/**/*'
